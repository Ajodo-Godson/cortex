...
- [x] Add a starter `README.md` in the project root if needed
...
- [x] Generate synthetic duel cases
- [x] Run reconciliation logic outside the live codebase
- [x] Generate meta-constraints
